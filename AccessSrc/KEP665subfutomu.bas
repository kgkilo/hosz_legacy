...
Private Sub txtPAR_AfterUpdate()
    'util.gridder Parent.cmbOBJTIP, Parent.cmbMEGNEV, Parent.grdGRID, cmbLEKPAR, txtPAR, "Alt"
    'Me![Param]![cmbLEKPAR], Me![Param]![txtPAR]
    'Me![Param].SourceObject = "Kep665 sub1obj"
End Sub
