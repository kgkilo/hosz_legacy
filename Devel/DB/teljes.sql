...
WHERE
	/*CONVERT(DATETIME,LABOR.MINTA_IDO,102) BETWEEN
		CONVERT(DATETIME,@pDATUM,102) AND CONVERT(DATETIME,DATEADD(month,-1,@pDATUM),102)*/
...
/****** Object:  Stored Procedure dbo.sp_LekerdJegyz    Script Date: 2000. 07. 04. 18:56:17 ******/
