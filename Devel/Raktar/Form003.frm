...
Begin VB.Form Form003 
   ...
   Begin TabDlg.SSTab TabForm03 
      ...
      Tab(0).Control(13)=   "txtH_GYSZAM"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "txtH_TIPUS"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "txtH_HITIDO"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "Text1txtH_ELHELYEZ"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "txtH_IMPULZUS"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "cmbH_LEOLV"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "txtH_PLOMBA"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "cmbH_ELEKTRONIIKA"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "cmbH_HELYZET"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "txtH_MEGJ"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "txtH_ID"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "txtH_KULCS"
      ...
      Tab(0).Control(28)=   "cmbH_TULAJDON"
      ...
      Tab(1).Control(13)=   "txtV_ELHELYEZ"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "txtV_HITIDO"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "txtV_TIPUS"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "txtV_GYSZAM"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "txtV_TOMEGARAM"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "txtV_ATMERO"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "txtV_ID"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "cmbV_TULAJDON"
      ...
      Tab(2).Control(14)=   "txtE_ELHELYEZ"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "txtE_HITIDO"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "txtE_TIPUS"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "txtE_GYSZAM"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "txtE_SZUKSHOSSZ"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "txtE_VEZHOSSZ"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "txtE_ID"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "txtE_PLOMBA"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "cmbE_TULAJDON"
